---
name: recon
description: Maps and documents codebases of any size by orchestrating parallel subagents. Creates docs/CODEBASE_MAP.md with architecture, health analysis, entrypoints, and actionable recommendations. Use when user says "map this codebase", "recon", "/recon", "create codebase map", "document the architecture", "understand this codebase", or when onboarding to a new project. Supports "--force" for full re-scan.
model: inherit
---
